...
public class AddressUtils {
     ...
     */
    public String getAddresses(String ip, String encodingString) throws Exception {
     ...
     * @return
     */
    private String getResult(String urlStr, String ip, String encoding) throws Exception {
        URL url = null;

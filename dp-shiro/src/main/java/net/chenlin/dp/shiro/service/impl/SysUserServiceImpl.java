...
public class SysUserServiceImpl implements SysUserService {
	...
	public Page<SysUserEntity> listUser(Map<String, Object> params) {
		Query form = new Query(params);                   // Query 其实就是一个map，我们为其提供了获取不同类型参数的方法，从而省去了类型转换的麻烦
		Page<SysUserEntity> page = new Page<>(form);	  // 当初始化传入的是Query查询对象时，Page对象会直接获取Query对象里的 pageNumber 和 pageSize 属性

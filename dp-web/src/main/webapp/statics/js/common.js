...
datetimeRender = function (opt) {
    var defaults = {
        ...
        theme: 'default',    // 主题 default（默认简约）、molv（墨绿背景）、#颜色值（自定义颜色背景）、grid（格子主题）
            ...
            //value日期生成的值，如：2017-08-18
            //date日期时间对象：{year: 2017, month: 8, date: 18, hours: 0, minutes: 0, seconds: 0}
            //endDate结束的日期时间对象，开启范围选择（range: true）才会返回。对象成员同上。
        },

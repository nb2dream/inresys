...
(function(factory) {
    ...
    */
    ...
    GridStackEngine.prototype.moveNode = function(node, x, y, width, height, noPack) {
        ...
        //console.log("1.width="+width+",height="+height+",x="+x+",y="+y+",grid.height="+this.height);
        if (typeof x != 'number') { x = node.x; }
        if (typeof y != 'number') { y = node.y; }
        if (typeof width != 'number') { width = node.width; }
        if (typeof height != 'number') { height = node.height; }
        ...
        //console.log("2.width="+width+",height="+height+",x="+x+",y="+y+",grid.height="+this.height);
        //this._fixCollisions(node);
        if (!noPack) {
          // this._packNodes();
           //this._notify();
    ...
    var GridStack = function(el, opts) {
        ...
        this.opts = _.defaults(opts || {}, {
            width: parseInt(this.container.attr('data-gs-width')) || 15,
    ...
    GridStack.prototype._updateContainerHeight = function() {
        ...
        // if(this.container.height() > 1080){
        //     console.log("不能大于1080，当前"+this.container.height());
        //     this.container.css("height",1080)
        // }
    ...
    GridStack.prototype.update = function(el, x, y, width, height) {
        this._updateElement(el, function(el, node) {
            ...
            width = (width !== null && typeof width != 'undefined') ? width : node.width;
            height = (height !== null && typeof height != 'undefined') ? height : node.height;
            console.log("grid.height="+this.grid.height);
